...
// Map function receives a mapby function and a slice and returns mapped slice by mapby.
// The mapby function receives an element and returns new element by mapby
